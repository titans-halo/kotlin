...
private fun processCLib(flavor: KotlinPlatform, cinteropArguments: CInteropArguments,
    ...
    val tool = prepareTool(cinteropArguments.target, flavor, runFromDaemon)
...
internal fun prepareTool(target: String?, flavor: KotlinPlatform, runFromDaemon: Boolean) =
        ToolConfig(target, flavor).also {
