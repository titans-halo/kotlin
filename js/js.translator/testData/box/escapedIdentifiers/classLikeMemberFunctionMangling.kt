...
@JsExport
class A {
    fun `run•invalid@test`(): Int = 41
    fun `run@invalid@test`(): Int = 34
    fun run_invalid_test(): Int = 23
}

class B {
    fun `run•invalid@test`(): Int = 42
    fun `run@invalid@test`(): Int = 35
    fun run_invalid_test(): Int = 24
}
