...
public class NativeBlackBoxTestGeneratedAlt extends AbstractNativeBlackBoxTest {
    @Nested
    ...
    public class Samples {
        ...
        public Collection<DynamicNode> testRegular_custom_args() throws Exception {
            return dynamicTest("native/native.tests/testData/samples/regular_custom_args.kt");
        }

        @TestFactory
        @TestMetadata("regular_multifile.kt")
        public Collection<DynamicNode> testRegular_multifile() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multifile_with_explicit_packages() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule_implicit_first_module() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule_implicit_first_module_with_header_comment() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule_implicit_first_module_with_header_statement() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule_with_header_comment() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_multimodule_with_header_statement() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_simple() throws Exception {
            return dynamicTest("native/native.tests/testData/samples/regular_simple.kt");
        }

        @TestFactory
        @TestMetadata("regular_simple_explicit_kind.kt")
        public Collection<DynamicNode> testRegular_simple_explicit_kind() throws Exception {
        ...
        public Collection<DynamicNode> testRegular_simple_with_output() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_multifile() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_multifile_entry_point() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_simple() throws Exception {
            return dynamicTest("native/native.tests/testData/samples/standalone_notr_simple.kt");
        }

        @TestFactory
        @TestMetadata("standalone_notr_simple2.kt")
        public Collection<DynamicNode> testStandalone_notr_simple2() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_simple_entry_point() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_simple_entry_point2() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_simple_with_input_and_output() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_notr_simple_with_output() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_simple() throws Exception {
        ...
        public Collection<DynamicNode> testStandalone_simple_with_output() throws Exception {
